...
void sdlconsole_goto(sdlconsole* c, int x, int y);
void sdlconsole_setcolor(sdlconsole* c, int is_fg, sdl_rgb_t color);
void sdlconsole_setcolors(sdlconsole* c, sdl_rgb_t bgcolor, sdl_rgb_t fgcolor);
...
void sdlconsole_getcursor(sdlconsole* c, int* x, int* y);
